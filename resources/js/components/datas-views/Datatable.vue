    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <b-table striped hover :items="items" :fields="fields" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" show-empty>
                ...
                <template v-slot:cell(actions)="row">
                    ...
                    <button id="delete" class="btn btn-danger btn-sm" @click="openDeleteModal(row)">Delete</button>
                </template>
            </b-table>
        </div>
        ...
        <div class="col-md-6">
            ...
            <b-modal v-model="deleteModal" :title="title">
                <p>Kamu yakin ingin menghapus data?</p>
...
export default {
    ...
    methods: {
        ...
        openDeleteModal(row) {
            ...
            this.title = row.item.id +' - '+row.item.name
        },
        deleteModalButton() {
